                            ...
                            <div className="-m-2 flex flex-wrap">
                                <form className="w-full" method="post">
                                    ...
                                    <div className="w-full p-2">
                                        <button className="mx-auto flex rounded border-0 bg-indigo-500 py-2 px-8 text-lg text-white hover:bg-indigo-600 focus:outline-none" type="submit">
                                            Send
                                        </button>
                                    </div>
                                </form>
                                ...
                                <div className="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
                                    ...
                                    <div className="flex justify-between items-baseline">
                                        <div className="">
                                            <h1 className="title-font mb-4 text-2xl font-medium text-white sm:text-3xl">Our Location</h1>
                                            <p className="my-5 leading-normal">Cairo, Egypt</p>
                                        </div>
                                        <div className="">
                                            <h1 className="title-font mb-4 text-2xl font-medium text-white sm:text-3xl"> Email </h1>
                                            <p>khaledah826@gmail.com</p>
                                        </div>
                                        <div className="">
                                            <h1 className="title-font mb-4 text-2xl font-medium text-white sm:text-3xl"> Phone </h1>
                                            <p>01090898650</p>
                                        </div>
                                    </div>
